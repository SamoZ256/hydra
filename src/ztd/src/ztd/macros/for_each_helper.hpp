...
#define ZTD_FOR_EACH_HELPER_0_1(macro, a, ...)                                 \
    macro(a) __VA_OPT__(ZTD_FOR_EACH_AGAIN_0_1 PARENS(macro, __VA_ARGS__))
...
#define ZTD_FOR_EACH_HELPER_0_2(macro, a1, a2, ...)                            \
    macro(a1, a2) __VA_OPT__(ZTD_FOR_EACH_AGAIN_0_2 PARENS(macro, __VA_ARGS__))
...
#define ZTD_FOR_EACH_HELPER_0_3(macro, a1, a2, a3, ...)                        \
    macro(a1, a2, a3)                                                          \
        __VA_OPT__(ZTD_FOR_EACH_AGAIN_0_3 PARENS(macro, __VA_ARGS__))
...
#define ZTD_FOR_EACH_HELPER_0_4(macro, a1, a2, a3, a4, ...)                    \
    macro(a1, a2, a3, a4)                                                      \
        __VA_OPT__(ZTD_FOR_EACH_AGAIN_0_4 PARENS(macro, __VA_ARGS__))
...
#define ZTD_FOR_EACH_HELPER_1_2(macro, e, a1, a2, ...)                         \
    macro(e, a1, a2)                                                           \
        __VA_OPT__(ZTD_FOR_EACH_AGAIN_1_2 PARENS(macro, e, __VA_ARGS__))
...
#define ZTD_FOR_EACH_HELPER_1_3(macro, e, a1, a2, a3, ...)                     \
    macro(e, a1, a2, a3)                                                       \
        __VA_OPT__(ZTD_FOR_EACH_AGAIN_1_3 PARENS(macro, e, __VA_ARGS__))
...
#define ZTD_FOR_EACH_HELPER_2_1(macro, e1, e2, a, ...)                         \
    macro(e1, e2, a)                                                           \
        __VA_OPT__(ZTD_FOR_EACH_AGAIN_2_1 PARENS(macro, e1, e2, __VA_ARGS__))
...
#define ZTD_FOR_EACH_HELPER_2_2(macro, e1, e2, a1, a2, ...)                    \
    macro(e1, e2, a1, a2)                                                      \
        __VA_OPT__(ZTD_FOR_EACH_AGAIN_2_2 PARENS(macro, e1, e2, __VA_ARGS__))
